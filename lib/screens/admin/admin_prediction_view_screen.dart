...
// ... (import lainnya)
import 'package:damiu/models/linear_regression_model.dart'; // Tambahkan import ini
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<DailySale>>(
      ...
      builder: (context, snapshot) {
        ...
        // Tambahkan pengecekan jumlah data historis
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Tidak cukup data historis untuk membuat prediksi. Minimal dibutuhkan 2 data penjualan.',
                    style: TextStyle(fontSize: 16),
                  ),
                  if (allSalesData.isNotEmpty) ...[
                    const SizedBox(height: 20),
                    const Text('Data Historis yang Tersedia (1 data):', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                    SizedBox(
                      ...
                      child: Card(
                        ...
                        child: DataTable(
                           ...
                           rows: allSalesData.map((sale) => DataRow(cells: [
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8), // Jarak antara grafik dan judul
